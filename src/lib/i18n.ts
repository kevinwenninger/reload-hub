...
export const t = {
  ...
  loads: {
    ...
    finalizeTitle: 'Finalize this version?',
    finalizeBody:
      'A finalized version becomes immutable. Further changes require a new version.',
    finalizedReadonly: 'This version is finalized and read-only.',
    bullet: 'Bullet',
    powder: 'Powder',
    primer: 'Primer',
    case: 'Case',
    ...
    deleteBody: 'This removes the load and all its draft versions. Finalized versions block deletion.',
    deleteVersionTitle: 'Delete draft version?',
    deleteVersionBody: 'This removes the draft. Finalized versions cannot be deleted.',
  },
  inventory: {
    stock: 'In stock',
    lowStock: 'Low',
